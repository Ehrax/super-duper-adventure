...
using TinderServer2.Providers;
using TinderServer2.Results;
...
namespace TinderServer2.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // POST api/account/ChangeProfileImage
        [Route("ChangeProfileImage")]
        [HttpPost]
        public async Task<IHttpActionResult> ChangeProfileImage(string base64Image)
        {
